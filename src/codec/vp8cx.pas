...
{$ELSEIF DEFINED(OSX64)}
  VPX_LIB = '/usr/local/lib/libvpx.dlyb';
{$ENDIF}
...
function vpx_codec_vp8_cx(): Pvpx_codec_iface_t; cdecl; external VPX_LIB;
function vpx_codec_vp9_cx(): Pvpx_codec_iface_t; cdecl; external VPX_LIB;
