...
type
  vpx_img_fmt = (VPX_IMG_FMT_NONE, VPX_IMG_FMT_YV12 = (VPX_IMG_FMT_PLANAR or
    VPX_IMG_FMT_UV_FLIP or 1), // planar YVU
...
type
  vpx_color_space = (VPX_CS_UNKNOWN = 0, // Unknown
...
type
  vpx_color_range = (VPX_CR_STUDIO_RANGE = 0,
...
function vpx_img_alloc(img: Pvpx_image_t; fmt: vpx_img_fmt_t;
  d_w, d_h: Cardinal; align: Cardinal): Pvpx_image_t; cdecl;
  external VPX_LIB name 'vpx_img_alloc';

function vpx_img_wrap(img: Pvpx_image_t; fmt: vpx_img_fmt_t; d_w, d_h: Cardinal;
  stride_align: Cardinal; img_data: PByte): Pvpx_image_t; cdecl;
  external VPX_LIB name 'vpx_img_wrap';

function vpx_img_set_rect(img: Pvpx_image_t; x, y, w, h: Cardinal): Integer;
  cdecl; external VPX_LIB name 'vpx_img_set_rect';

procedure vpx_img_flip(img: Pvpx_image_t); cdecl;
  external VPX_LIB name 'vpx_img_flip';

procedure vpx_img_free(img: Pvpx_image_t); cdecl;
  external VPX_LIB name 'vpx_img_free';
