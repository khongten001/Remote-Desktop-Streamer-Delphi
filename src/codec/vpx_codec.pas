...
function vpx_codec_version: Integer; cdecl; external VPX_LIB;
function vpx_codec_version_str: PAnsiChar; cdecl; external VPX_LIB;
function vpx_codec_version_extra_str: PAnsiChar; cdecl; external VPX_LIB;
function vpx_codec_build_config: PAnsiChar; cdecl; external VPX_LIB;
function vpx_codec_iface_name(iface: Pvpx_codec_iface_t): PAnsiChar; cdecl; external VPX_LIB;
function vpx_codec_err_to_string(err: vpx_codec_err_t): PAnsiChar; cdecl; external VPX_LIB;
function vpx_codec_error(ctx: Pvpx_codec_ctx): PAnsiChar; cdecl; external VPX_LIB;
function vpx_codec_error_detail(ctx: Pvpx_codec_ctx): PAnsiChar; cdecl; external VPX_LIB;
function vpx_codec_destroy(ctx: Pvpx_codec_ctx): vpx_codec_err_t; cdecl; external VPX_LIB;
function vpx_codec_get_caps(iface: Pvpx_codec_iface_t): vpx_codec_caps_t; cdecl; external VPX_LIB;
function vpx_codec_control_(ctx: Pvpx_codec_ctx; ctrl_id: Integer): vpx_codec_err_t; cdecl; varargs; external VPX_LIB;
