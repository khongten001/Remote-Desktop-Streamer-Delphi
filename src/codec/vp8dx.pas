...
// Function prototypes
function vpx_codec_vp8_dx: vpx_codec_iface_t; cdecl; external VPX_LIB;
function vpx_codec_vp9_dx: vpx_codec_iface_t; cdecl; external VPX_LIB;

function vpx_codec_dec_init_ver(ctx: Pvpx_codec_ctx_t; iface: vpx_codec_iface_t; cfg: Pointer; flags: Cardinal; ver: Integer): vpx_codec_err_t; cdecl; external VPX_LIB;
function vpx_codec_decode(ctx: Pvpx_codec_ctx_t; data: PByte; data_sz: Cardinal; user_priv: Pointer; deadline: Int64): vpx_codec_err_t; cdecl; external VPX_LIB;
function vpx_codec_get_frame(ctx: Pvpx_codec_ctx_t; iter: vpx_codec_iter_t): Pointer; cdecl; external VPX_LIB;
function vpx_codec_destroy(ctx: Pvpx_codec_ctx_t): vpx_codec_err_t; cdecl; external VPX_LIB;
function vpx_codec_control_(ctx: Pvpx_codec_ctx_t; ctrl_id: Integer): vpx_codec_err_t; cdecl; varargs; external VPX_LIB;
